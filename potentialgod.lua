-- ====================================================================
-- [DIX] FINAL SCRIPT V39.0 (STABLE GUI + MOBILE FIX)
-- FIX: Reverted GUI structure to V33.0 stable base.
-- ADD: Re-applied Enum.KeyCode.Space trigger for Silent Aim on Mobile.
-- Default features are forced ON for immediate testing.
-- ====================================================================
...
if WindUi and WindUi.CreateWindow then 
    local Window = WindUi:CreateWindow({
        Title = "DIX HUB V39.0 (Mobile Stable)",
        Author = "by Dixyi",
        Folder = "DIX_Hub_V39_Final",
        OpenButton = { 
            Title = "DIX OPEN", 
    ...
    -- Tags
    Window:Tag({ Title = "V39.0", Icon = "mobile", Color = Color3.fromHex("#6b31ff") })
    ...
    print("DIX HUB V39.0 GUI SUCCESSFULLY LAUNCHED (Mobile Stable).")
else
...
print("DIX HUB V39.0 Core logic initialized.")
