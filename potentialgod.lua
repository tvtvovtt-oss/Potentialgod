-- ====================================================================
-- [DIX] FINAL SCRIPT V36.0 (MOBILE OPTIMIZED)
-- FIX: Added Enum.KeyCode.Space (Virtual Button) as a secondary 
-- trigger for Silent AIM to improve mobile reliability.
-- ====================================================================

-- 1. Load WindUi Library (Standard reliable link)
local success, WindUi = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/Footagesus/WindUI/main/dist/main.lua"))()
end)

if not success or not WindUi then
    print("[DIX ERROR] WindUI failed to load! Only core functions are potentially running.")
...
-- (Aimbot logic remains the same - Target finding and camera movement)
-- ====================================================================
...
ContextActionService:BindAction("SilentAimShot", function(actionName, inputState, inputObject)
    if inputState == Enum.UserInputState.Begin then
        -- Check for MOUSE BUTTON 1 (Primary attack/touch on mobile) OR SPACE (Virtual button)
...
-- ====================================================================
-- [ESP Core Functions] 
-- (Visuals logic remains the same)
-- ====================================================================
...
if WindUi then
    local Window = WindUi:CreateWindow({
        Title = "DIX HUB V36.0 (Mobile)",
        Author = "by Dixyi",
        Folder = "DIX_Hub_V36_Final",
        OpenButton = { 
            Title = "DIX OPEN", 
    ...
    -- Tags
    Window:Tag({ Title = "V36.0", Icon = "mobile", Color = Color3.fromHex("#6b31ff") })
    ...
    AimSection:Toggle({ 
        ...
        Desc = "Uses bypass structure. Trigger with **Touch/M1** or **Virtual Jump Button**.", 
    ...
    print("DIX HUB V36.0 GUI SUCCESSFULLY LAUNCHED (Mobile Ready).")
end
...
print("DIX HUB V36.0 Core logic initialized.")
