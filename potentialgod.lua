-- ====================================================================
-- [DIX] FINAL SCRIPT V30.3 (GUI Reorganization)
-- FIX: Moved Target Part Selector to its own dedicated section on the COMBAT tab.
-- Config Saving and stability fixes retained.
-- ====================================================================
...
-- ====================================================================
-- [DIX CONFIG CORE] - Save & Load (Retained)
-- ====================================================================

local function SaveConfig()
    if not WindUi or not WindUi.SaveSettings then 
        print("[DIX ERROR] WindUi Save function not available.")
        return 
    end
...
local function LoadConfig()
    if not WindUi or not WindUi.LoadSettings then 
        print("[DIX INFO] WindUi Load function not available, using defaults.")
        return 
    end
...
if WindUi then
    ...
    -- ================================================================
    -- COMBAT SECTION 3: Hitbox Expander Settings (УДАЛЕНО)
    -- ================================================================
    ...
    print("DIX HUB V30.3 launched. GUI structure corrected.")
end
