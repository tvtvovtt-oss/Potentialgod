-- ====================================================================
-- [DIX] FINAL SCRIPT V37.0 (USER GUI LINK REVERT & MOBILE)
-- FIX: Reverting WindUI loadstring to user's preferred link for stability.
-- Core logic and mobile optimization are preserved.
-- ====================================================================

-- 1. Load WindUi Library (Reverting to user-provided link for stability)
local success, WindUi = pcall(function()
    -- Используем ссылку, которую вы предоставили в начале:
    return loadstring(game:HttpGet('https://raw.githubusercontent.com/Footagesus/WindUI/refs/heads/main/main_example.lua'))()
end)

if not success or not WindUi then
    print("[DIX ERROR] WindUI failed to load using the preferred link! Core functions may still be available.")
...
if WindUi and WindUi.CreateWindow then -- Проверяем, что WindUI был загружен корректно и имеет нужные функции
    local Window = WindUi:CreateWindow({
        Title = "DIX HUB V37.0 (Mobile)",
        Author = "by Dixyi",
        Folder = "DIX_Hub_V37_Final",
        OpenButton = { 
            Title = "DIX OPEN", 
    ...
    -- Tags
    Window:Tag({ Title = "V37.0", Icon = "mobile", Color = Color3.fromHex("#6b31ff") })
    ...
    print("DIX HUB V37.0 GUI SUCCESSFULLY LAUNCHED (Mobile Ready).")
else
...
print("DIX HUB V37.0 Core logic initialized.")
